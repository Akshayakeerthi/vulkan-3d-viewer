...
def createRenderPass(device, StageMask, msaaSamples, depthFormat, ImageFormat):
    ...
    colorAttachmentRef2 = VkAttachmentReference(2, VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL)    
    depthAttachmentRef = VkAttachmentReference(1, VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL)
    
    subpass = VkSubpassDescription(
        pipelineBindPoint       = VK_PIPELINE_BIND_POINT_GRAPHICS,
        pResolveAttachments     = [colorAttachmentRef2],
        pColorAttachments       = [colorAttachmentRef1],
    ...
    renderPassInfo = VkRenderPassCreateInfo(
        pAttachments  = [colorAttachment1, depthAttachment, colorAttachment2],
        pSubpasses    = [subpass],
